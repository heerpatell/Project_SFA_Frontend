    ...
    <>
        <div style={{
          ...
          <div style={{
            ...
            <div style={{textAlign:'center', fontSize:'2rem', marginBottom:'1rem', color:'#1c1c1c'}}><u><b>BACKGROUND</b></u></div>
            <div style={{fontSize:'1.5rem', color:'#1c1c1c'}}><b>Role</b></div>
            ...
            <div style={{fontSize:'1.5rem', color:'#1c1c1c'}}><b>Rounds and Dyads</b></div>     
            ...
            <div style={{fontSize:'1.5rem', color:'#1c1c1c'}}><b>Earnings</b></div>
