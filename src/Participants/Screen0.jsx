    ...
    <>
      <div className="participant-info-outer">
        <div className="participant-info-box">
          <div className="participant-info-heading">
            <u>
          ...
          >
            ...
            <div>
              ...
              be randomly assigned to the role of either a customer or a worker
              in a service setting. Customers and workers will be paired
              together to form dyads. If you agree, you will then be able to
              continue with the study, which will be completed during one in-lab
              session and will last about 45 minutes.
              <br />
              <br />
              ...
              identifying information will be asked of you. Your identity will
              be confidential. <br />
            </div>
            <br />
            <div>
              ...
              study beyond that of everyday activities. That means that the
              risks of participating are no more likely or serious than those
              you encounter in everyday activities.
            </div>
            <br />
            <div>
              <b>
            ...
            <div>
              ...
              You will receive at least $5 for your participation with an
              expected average payout of at least $10. You can collect any
              monetary payment when you leave the experimental lab after
            ...
            <div>
              ...
              to answer any of the questions if you so wish by advancing to the
              next screen without completing the question(s). Further, you may
              decide to withdraw from this study at any time by closing the
            ...
            <div>
              ...
              participation will be shared by the researchers on the project.
              The records of this study will be stored securely on a password
              protected server and kept confidential for the duration of the
              study and corresponding research program (at least two years). All
              publications will exclude any information that will make it
              possible to identify you as a participant. This study will be
              completed through a private password-protected online platform.
              When information is transmitted/stored on the internet, privacy
              cannot be guaranteed. There is a risk your responses may be
              intercepted by a third party. Once all the data are collected and
              analyzed for this project, we plan on sharing this information
              with the research community through seminars, conferences,
              presentations, and journal articles. We will only analyze the data
              in the aggregate (across all participants) and not individually.
            </div>
            <br />
            <b>
            ...
            <div>
              {" "}
              You may ask any questions about the research at any time to the
            ...
            <div>
              ...
              a University of Waterloo Research Ethics Board (REB #). If you
              have questions for the Board, contact the Office of Research
            ...
            <div>
              ...
              agree that you have asked any questions you might have and are
              clear on how to stop your participation if you choose to. By
              agreeing to participate, you are not waiving your legal rights or
              releasing the investigator(s) or involved institution(s) from
