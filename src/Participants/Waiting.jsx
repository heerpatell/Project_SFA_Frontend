    ...
    >
      <div style={{ color: "white", fontSize: "3rem" }}>
        {assignedCategory === "Worker" && (
          <div style={{color:'#1c1c1c'}}>Please wait while the Customer makes their decision</div>
        )}
        {assignedCategory === "Customer" && (
          <div style={{color:'#1c1c1c'}}>Please wait while the Worker makes their decision</div>
        )}
      </div>
    </div>
  );
